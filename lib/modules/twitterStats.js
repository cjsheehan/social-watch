...
export function addSentiment(a, b) {
	...
	let aPosComparative = getComparative(a.positive.score, aNumTokens);
	let bPosComparative = getComparative(b.positive.score, bNumTokens);
	positive.comparative = aPosComparative + bPosComparative;

	let aNegComparative = getComparative(a.negative.score, aNumTokens);
	let bNegComparative = getComparative(b.negative.score, bNumTokens);
	negative.comparative = aNegComparative + bNegComparative;


	// console.log();
	// console.log("check isNaN ascore acomp", a.score, a.comparative);
	// console.log("sentimentA:" + JSON.stringify(a));
	// console.log("check isNaN bscore bcomp", b.score, b.comparative);
	// console.log("sentimentB:" + JSON.stringify(b));
	// console.log();
