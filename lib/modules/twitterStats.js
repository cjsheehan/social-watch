...
export function tweetStats(tweets) {
	...
	// create a comparative ordered object: map comparative score to array
	let comparativeList = Object.keys(wordStats.words).map(function (word) {
		return [word, wordStats.words[word].sentiment.comparative];
	});
